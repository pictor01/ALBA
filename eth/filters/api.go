...
// `alba_getFilterChanges` polling method that is also used for log filters.
//
...
type FilterCriteria alba.FilterQuery
...
//
// https://alba.wiki/json-rpc/API#eth_getlogs
...
//
// https://alba.wiki/json-rpc/API#eth_uninstallfilter
...
//
// https://alba.wiki/json-rpc/API#eth_getfilterlogs
...
//
// https://alba.wiki/json-rpc/API#eth_getfilterchanges
